export default {
    ...
    // APPS
		{index: 2, label: 'Realtime', url: '/apps/calendar/vue-simple-calendar', labelIcon: 'MapIcon', highlightAction: true},
		{index: 3, label: 'History', url: '/apps/calendar/vue-fullcalendar', labelIcon: 'ClockIcon', highlightAction: true},
		// {index: 4, label: 'Registe device', url: '/ui-elements/card/card-colors', labelIcon: 'EditIcon', highlightAction: true},
		{index: 5, label: 'Manage device', url: '/ui-elements/card/basic', labelIcon: 'ListIcon', highlightAction: true},
    // {index: 6, label: 'Calendar', url: '/apps/calendar/vue-simple-calendar', labelIcon: 'CalendarIcon', highlightAction: true},
