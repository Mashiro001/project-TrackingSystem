...
const router = new Router({
    ...
    // =============================================================================
        ...
        // =============================================================================
                {
                    path: '/',
                    redirect: '/apps/calendar/realtime'
                },
                // {
        ...
        // =============================================================================
                ...
                // },
                {
                    path: '/apps/calendar/history',
                    name: 'calendarFullCalendar',
                    component: () => import('./views/apps/calendar/history.vue'),
                    meta: {
                        rule: 'editor'
                    }
                },
                {
                    path: '/apps/calendar/realtime',
                    name: 'calendarSimpleCalendar',
                    component: () => import('./views/apps/calendar/realtime.vue'),
                    meta: {
                        rule: 'editor'
                    }
                },
                {
                    path: '/apps/calendar/realtimetest',
                    name: 'realtimetest',
                    component: () => import('./views/apps/calendar/realtimetest.vue'),
                    meta: {
                        rule: 'editor'
                    }
                },
        ...
        // =============================================================================
                ...
                // },
                {
                    path: '/ui-elements/card/manageDevice',
                    name: 'cardColors',
                    component: () => import('./views/ui-elements/card/manageDevice.vue'),
                    meta: {
                        // breadcrumb: [
                        //     { title: 'Home', url: '/' },
                        //     { title: 'Card' },
